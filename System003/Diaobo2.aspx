...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
     ...
     <asp:Button ID="Button11" runat="server" OnClick="Button11_Click" Text="全选" class="button"/>
     <asp:Button ID="Button12" runat="server" PostBackUrl="~/Diaobo.aspx" Text="上一步" class="button"/>
    <asp:Button ID="Button7" runat="server" OnClick="Button7_Click" Text="下一步" class="button"/>
</asp:Content>
