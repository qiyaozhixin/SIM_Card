...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    ...
    <div class="content">
    <asp:Button ID="Button7" runat="server" Text="直销员工" OnClick="Button7_Click" class="button button3"/>
    <asp:Button ID="Button8" runat="server" Text="地推网点" OnClick="Button8_Click" class="button button3"/>
    ...
    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" PageSize="5" CssClass="GridViewStyle">       
        <FooterStyle CssClass="GridViewFooterStyle"/>
        <RowStyle CssClass="GridViewRowStyle"/>   
        <SelectedRowStyle CssClass="GridViewSelectedRowStyle"/>
        <PagerStyle CssClass="GridViewPagerStyle"/>
    ...
    <asp:Label ID="Label3" runat="server" Text="注意：只能选择其中一项!"></asp:Label>
    <br />
    <asp:Button ID="Button9" runat="server" OnClick="Button9_Click" Text="下一步" class="button"/>
    </div>
</asp:Content>
